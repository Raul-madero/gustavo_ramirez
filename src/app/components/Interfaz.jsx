        ...
        <Container className="my-3">
            ...
            <Container className="d-flex justify-content-between mt-3">
                <Card style={{width: "350px"}}>
                    <Image className="mw-100" src={financieros} alt="Estados financieros" />
                    <CardBody>
                        <CardTitle className="text-center">Estados Financieros</CardTitle>
                    </CardBody>
                </Card>
                <Card style={{width: "350px"}}>
                    <Image className="mw-100" src={tax} alt="Estados financieros" />
                    <CardBody>
                        <CardTitle className="text-center">SAT</CardTitle>
                    </CardBody>
                </Card>
                <Card style={{width: "350px"}}>
                    <Image className="mw-100" src={work} alt="Estados financieros" />
                    <CardBody>
